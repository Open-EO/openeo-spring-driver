...
public class WCPSApplyFunc {
	...
	// Create WCPS query for whole Apply Process Callback Functions
		String createApplyWCPSString(String wcpsEndpoint, String openEOEndpoint, JSONObject openEOGraph, String applyNodeKey, String payLoad, String filterString, String collectionVar, String collectionID) {

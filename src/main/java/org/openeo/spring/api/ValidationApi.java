...
import org.openeo.spring.model.ValidationResponse;
...
public interface ValidationApi {
    ...
    default ResponseEntity<ValidationResponse> validateCustomProcess(@ApiParam(value = "Specifies the user-defined process to be validated." ,required=true )  @Valid @RequestBody ProcessGraphWithMetadata processGraphWithMetadata) {

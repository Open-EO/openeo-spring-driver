...
public interface ProcessesApi {
     ...
     */
    @ApiOperation(value = "Supported predefined processes", nickname = "listProcesses", notes = "The request asks the back-end for available predefined processes and returns detailed process descriptions, including parameters and return values.", response = Processes.class, authorizations = {
        @Authorization(value = "Bearer")
    }, tags={ "Process Discovery", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Formal specification describing the supported predefined processes.", response = Processes.class),

...
public interface CollectionsApi {
    ...
    default ResponseEntity<Collection> describeCollection(@Pattern(regexp="^[\\w\\-\\.~/]+$") @Parameter(name = "Collection identifier",required=true) @PathVariable("collection_id") String collectionId, Principal principal){
        return new ResponseEntity<Collection>(HttpStatus.NOT_IMPLEMENTED);
    }
    
    /**
     * GET /collections/{collection_id}/coverage : Full metadata for a specific dataset
     * Lists **all** information about a specific collection specified by the identifier &#x60;collection_id&#x60;.  This endpoint is compatible with [STAC 0.9.0](https://stacspec.org) and [OGC API - Features](http://docs.opengeospatial.org/is/17-069r3/17-069r3.html). [STAC API](https://github.com/radiantearth/stac-spec/tree/v0.9.0/api-spec) features / extensions and [STAC extensions](https://github.com/radiantearth/stac-spec/tree/v0.9.0/extensions) can be implemented in addition to what is documented here.
     *
     * @param collectionId Collection identifier (required)
     * @return JSON object with the full collection metadata. (status code 200)
    ...
    default ResponseEntity<?> getCoverage(@Pattern(regexp="^[\\w\\-\\.~/]+$")
    @Parameter(name = "Collection identifier",required=true) 
//    @RequestParam(name = "subset",required = false)
//    @RequestParam(name = "bbox",required = false)
    //@RequestParam(name = "datetime",required = false) String dateString,
    //@RequestParam(name = "bbox",required = false) List<Double> bboxArray,
...
//    @RequestParam(name = "",required = false)
//    @RequestParam(name = "",required = false) 
    @PathVariable("collection_id") String collectionId, Principal principal){
        return new ResponseEntity<Collection>(HttpStatus.NOT_IMPLEMENTED);
    }

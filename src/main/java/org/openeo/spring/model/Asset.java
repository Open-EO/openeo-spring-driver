...
public class Asset   {
  ...
  /**
   * URL to the downloadable asset. The URLs SHOULD be available without authentication so that external clients can download them easily. If the data is confidential, signed URLs SHOULD be used to protect against unauthorized access from third parties.
   * @return href
  */
  ...
  */
  ...
  /**
   * Multi-line description to explain the asset.  [CommonMark 0.29](http://commonmark.org/) syntax MAY be used for rich text representation.
   * @return description
  */
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Asset asset = (Asset) o;
    return Objects.equals(this.href, asset.href) &&

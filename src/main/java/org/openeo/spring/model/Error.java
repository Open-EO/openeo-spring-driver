 ...
 * server-side error. See also: * [Error
 * Handling](#section/API-Principles/Error-Handling) in the API in general. *
...
public class Error {
	...
	/**
	 * The code is either one of the standardized error codes or a custom code, for
	 * example specified by a user in the `debug` process.
	 * 
	 * @return code
	 */
	...
	/**
	 * A message explaining what the client may need to change or what difficulties
	 * the server is facing.
	 * 
	 * @return message
	 */
	...
	/**
	 * Links related to this log entry / error, e.g. to a resource that provides
	 * further explanations. For relation types see the lists of [common relation
	 * types in openEO](#section/API-Principles/Web-Linking).
	 * 
	 * @return links
	 */
	...
	public boolean equals(java.lang.Object o) {
		...
		Error error = (Error) o;
		return Objects.equals(this.id, error.id) && Objects.equals(this.code, error.code)
				&& Objects.equals(this.message, error.message) && Objects.equals(this.links, error.links);
	}

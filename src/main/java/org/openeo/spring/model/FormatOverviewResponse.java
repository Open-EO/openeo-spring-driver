...
public class FormatOverviewResponse   {
  @JsonProperty("input")
  @Valid
  ...
  public FormatOverviewResponse input(Map<String, FileFormat> input) {
    this.input = input;
    return this;
  }

  public FormatOverviewResponse putInputItem(String key, FileFormat inputItem) {
  ...
  */
  ...
  public FormatOverviewResponse output(Map<String, FileFormat> output) {
    this.output = output;
    return this;
  }

  public FormatOverviewResponse putOutputItem(String key, FileFormat outputItem) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FormatOverviewResponse formatOverviewResponse = (FormatOverviewResponse) o;
    return Objects.equals(this.input, formatOverviewResponse.input) &&
        Objects.equals(this.output, formatOverviewResponse.output);
  }
  ...
  public String toString() {
    ...
    sb.append("class FormatOverviewResponse {\n");

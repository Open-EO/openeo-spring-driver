...
public class STACCollectionExtentSpatial   {
  ...
  public STACCollectionExtentSpatial bbox(List<List<BigDecimal>> bbox) {
    this.bbox = bbox;
    return this;
  }

  public STACCollectionExtentSpatial addBboxItem(List<BigDecimal> bboxItem) {
    if (this.bbox == null) {
...
@Size(min=1) 
  ...
  public boolean equals(java.lang.Object o) {
    ...
    STACCollectionExtentSpatial stACCollectionExtentSpatial = (STACCollectionExtentSpatial) o;
    return Objects.equals(this.bbox, stACCollectionExtentSpatial.bbox);
  }
  ...
  public String toString() {
    ...
    sb.append("class STACCollectionExtentSpatial {\n");

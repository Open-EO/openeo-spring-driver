...
public class Process {
	...
	private Map<String, String> processGraph = null;
...
//	private Map<String, Process> processGraph = null;
	...
	public Process processGraph(Map<String, String> processGraph) {
		this.processGraph = processGraph;
		return this;
	}

	public Process putProcessGraphItem(String key, String processGraphItem) {
	...
	public Map<String, String> getProcessGraph() {
		return processGraph;
	}

	public void setProcessGraph(Map<String, String> processGraph) {
		this.processGraph = processGraph;
	}

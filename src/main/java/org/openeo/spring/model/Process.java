...
public class Process {
	...
	@Valid
	@ElementCollection
	@CollectionTable(name = "process_exception", joinColumns = {@JoinColumn(name = "process_id", referencedColumnName = "id")})
	...
	public Process exceptions(Map<String, Object> exceptions) {
		this.exceptions = exceptions;
		return this;
	}

	public Process putExceptionsItem(String key, Object exceptionsItem) {
	...
	public Process processGraph(Map<String, Object> processGraph) {
		this.processGraph = processGraph;
		return this;
	}

	public Process putProcessGraphItem(String key, Object processGraphItem) {

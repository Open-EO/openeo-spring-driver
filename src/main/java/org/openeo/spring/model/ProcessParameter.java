...
import org.openeo.spring.model.ProcessParameterAllOf;
...
@Pattern(regexp="^\\w+$") 
  ...
  */
  ...
  public ProcessParameter optional(Boolean optional) {
  ...
  */
  ...
  public ProcessParameter _default(Object _default) {

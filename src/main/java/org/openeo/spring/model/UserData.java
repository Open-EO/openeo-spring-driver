...
@Pattern(regexp="^[\\w\\-\\.~]+$") 
  ...
  */
  ...
  public UserData storage(UserStorage storage) {
  ...
  */
  ...
  public UserData budget(BigDecimal budget) {
  ...
  */
  ...
  public UserData links(List<Link> links) {
    this.links = links;
    return this;
  }

  public UserData addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  */
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.userId, userData.userId) &&
        ...
        Objects.equals(this.storage, userData.storage) &&
        Objects.equals(this.budget, userData.budget) &&
